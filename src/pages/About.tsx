...
export function About() {
  return (
    <MainTemplate>
      <div className="min-h-screen flex flex-col justify-center items-center gap-3 pb-20 pt-30 px-6 ">
        <h1 className="text-3xl text-center">
          Sobre o NCB – Núcleo Cyber Brasil
        </h1>
        <h2 className="text-2xl">Quem Somos</h2>
        <p className="text-justify max-w-xl px-2">
        ...
        <ul className="text-justify max-w-xl px-16">
          <li className="list-disc">
            Promover encontros regulares para debater temas atuais e emergentes
            da área;
          </li>
          <li className="list-disc">
            Incentivar a troca de experiências entre estudantes, pesquisadores e
            profissionais;
          </li>
          <li className="list-disc">
        ...
        <p className="text-justify max-w-xl px-2">
          O NCB realiza diversas atividades voltadas para o aprendizado contínuo
          e impacto social:
        </p>
        <ul className="text-justify max-w-xl px-16">
          <li className="list-disc">
        ...
        <ul className="text-justify max-w-xl px-2 pl-16">
          <li className="list-disc">
